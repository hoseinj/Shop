...
public class CountryResourceIT {
    ...
    private static final String DEFAULT_ISO_CODE_2 = "AAAAAAAAAA";
    private static final String UPDATED_ISO_CODE_2 = "BBBBBBBBBB";

    private static final String DEFAULT_ISO_CODE_3 = "AAAAAAAAAA";
    private static final String UPDATED_ISO_CODE_3 = "BBBBBBBBBB";

    private static final String DEFAULT_ADDRESS_FORMAT = "AAAAAAAAAA";
    private static final String UPDATED_ADDRESS_FORMAT = "BBBBBBBBBB";

    private static final Integer DEFAULT_POST_CODE_REQUIRED = 1;
    private static final Integer UPDATED_POST_CODE_REQUIRED = 2;
    ...
    public static Country createEntity(EntityManager em) {
        Country country = new Country()
            .name(DEFAULT_NAME)
            .isoCode2(DEFAULT_ISO_CODE_2)
            .isoCode3(DEFAULT_ISO_CODE_3)
            .addressFormat(DEFAULT_ADDRESS_FORMAT)
            .postCodeRequired(DEFAULT_POST_CODE_REQUIRED)
    ...
    public static Country createUpdatedEntity(EntityManager em) {
        Country country = new Country()
            .name(UPDATED_NAME)
            .isoCode2(UPDATED_ISO_CODE_2)
            .isoCode3(UPDATED_ISO_CODE_3)
            .addressFormat(UPDATED_ADDRESS_FORMAT)
            .postCodeRequired(UPDATED_POST_CODE_REQUIRED)
    ...
    public void createCountry() throws Exception {
        ...
        assertThat(testCountry.getIsoCode2()).isEqualTo(DEFAULT_ISO_CODE_2);
        assertThat(testCountry.getIsoCode3()).isEqualTo(DEFAULT_ISO_CODE_3);
        assertThat(testCountry.getAddressFormat()).isEqualTo(DEFAULT_ADDRESS_FORMAT);
        assertThat(testCountry.getPostCodeRequired()).isEqualTo(DEFAULT_POST_CODE_REQUIRED);
        ...
        assertThat(testCountry.getModifiedDate()).isEqualTo(DEFAULT_MODIFIED_DATE);
    }
    ...
    public void getAllCountries() throws Exception {
        ...
        restCountryMockMvc.perform(get("/api/countries?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].isoCode2").value(hasItem(DEFAULT_ISO_CODE_2)))
            .andExpect(jsonPath("$.[*].isoCode3").value(hasItem(DEFAULT_ISO_CODE_3)))
            .andExpect(jsonPath("$.[*].addressFormat").value(hasItem(DEFAULT_ADDRESS_FORMAT)))
            .andExpect(jsonPath("$.[*].postCodeRequired").value(hasItem(DEFAULT_POST_CODE_REQUIRED)))
    ...
    public void getCountry() throws Exception {
        ...
        restCountryMockMvc.perform(get("/api/countries/{id}", country.getId()))
            ...
            .andExpect(jsonPath("$.isoCode2").value(DEFAULT_ISO_CODE_2))
            .andExpect(jsonPath("$.isoCode3").value(DEFAULT_ISO_CODE_3))
            .andExpect(jsonPath("$.addressFormat").value(DEFAULT_ADDRESS_FORMAT))
            .andExpect(jsonPath("$.postCodeRequired").value(DEFAULT_POST_CODE_REQUIRED))
    ...
    public void updateCountry() throws Exception {
        ...
        assertThat(testCountry.getIsoCode2()).isEqualTo(UPDATED_ISO_CODE_2);
        assertThat(testCountry.getIsoCode3()).isEqualTo(UPDATED_ISO_CODE_3);
        assertThat(testCountry.getAddressFormat()).isEqualTo(UPDATED_ADDRESS_FORMAT);
        assertThat(testCountry.getPostCodeRequired()).isEqualTo(UPDATED_POST_CODE_REQUIRED);
        ...
        assertThat(testCountry.getModifiedDate()).isEqualTo(UPDATED_MODIFIED_DATE);
    }
