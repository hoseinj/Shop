...
import { ProductRelatedComponent } from 'app/entities/product-related/product-related.component';
...
describe('Component Tests', () => {
  describe('ProductRelated Management Component', () => {
    let comp: ProductRelatedComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ProductRelatedComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.productRelateds[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
