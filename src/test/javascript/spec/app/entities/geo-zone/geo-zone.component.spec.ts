...
import { GeoZoneComponent } from 'app/entities/geo-zone/geo-zone.component';
import { GeoZoneService } from 'app/entities/geo-zone/geo-zone.service';
import { GeoZone } from 'app/shared/model/geo-zone.model';

describe('Component Tests', () => {
  describe('GeoZone Management Component', () => {
    let comp: GeoZoneComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(GeoZoneComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.geoZones[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
