...
import { LoginLogComponent } from 'app/entities/login-log/login-log.component';
...
describe('Component Tests', () => {
  describe('LoginLog Management Component', () => {
    let comp: LoginLogComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(LoginLogComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.loginLogs[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
