...
import { ShopUserComponent } from 'app/entities/shop-user/shop-user.component';
...
describe('Component Tests', () => {
  describe('ShopUser Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.shopUsers[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
