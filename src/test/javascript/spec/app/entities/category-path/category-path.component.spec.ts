...
import { CategoryPathComponent } from 'app/entities/category-path/category-path.component';
...
describe('Component Tests', () => {
  describe('CategoryPath Management Component', () => {
    let comp: CategoryPathComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CategoryPathComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.categoryPaths[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
