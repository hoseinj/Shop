...
import { OrderOptionComponent } from 'app/entities/order-option/order-option.component';
...
describe('Component Tests', () => {
  describe('OrderOption Management Component', () => {
    let comp: OrderOptionComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(OrderOptionComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.orderOptions[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
