...
import { ProductTagComponent } from 'app/entities/product-tag/product-tag.component';
  ...
  describe('ProductTag Management Component', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ProductTagComponent, '')
        .compileComponents();
