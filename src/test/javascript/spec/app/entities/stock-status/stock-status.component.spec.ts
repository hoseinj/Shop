...
import { StockStatusComponent } from 'app/entities/stock-status/stock-status.component';
...
describe('Component Tests', () => {
  describe('StockStatus Management Component', () => {
    let comp: StockStatusComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(StockStatusComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.stockStatuses[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
