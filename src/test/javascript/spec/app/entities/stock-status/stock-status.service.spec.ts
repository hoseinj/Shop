...
describe('Service Tests', () => {
  describe('StockStatus Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new StockStatus(0, 'AAAAAAA', 0, 0, 0, 'AAAAAAA', 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a StockStatus', () => {
      ...
      it('should update a StockStatus', () => {
        const returnedFromService = Object.assign(
          {
            name: 'BBBBBB',
            isActive: 1,
      ...
      it('should return a list of StockStatus', () => {
        const returnedFromService = Object.assign(
          {
            name: 'BBBBBB',
            isActive: 1,
      ...
      it('should delete a StockStatus', () => {
