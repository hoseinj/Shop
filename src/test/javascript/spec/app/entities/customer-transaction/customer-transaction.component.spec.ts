...
import { CustomerTransactionComponent } from 'app/entities/customer-transaction/customer-transaction.component';
...
describe('Component Tests', () => {
  describe('CustomerTransaction Management Component', () => {
    let comp: CustomerTransactionComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CustomerTransactionComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      spyOn(service, 'query').and.returnValue(
        of(
          new HttpResponse({
            body: [new CustomerTransaction(123)],
            headers
          })
        )
      );
