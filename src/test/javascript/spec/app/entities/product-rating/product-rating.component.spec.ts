...
import { ProductRatingComponent } from 'app/entities/product-rating/product-rating.component';
...
describe('Component Tests', () => {
  describe('ProductRating Management Component', () => {
    let comp: ProductRatingComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ProductRatingComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.productRatings[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
