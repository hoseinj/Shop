...
import { CustomerGroupComponent } from 'app/entities/customer-group/customer-group.component';
...
describe('Component Tests', () => {
  describe('CustomerGroup Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.customerGroups[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
