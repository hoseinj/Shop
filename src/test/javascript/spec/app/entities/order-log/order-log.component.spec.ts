...
import { OrderLogComponent } from 'app/entities/order-log/order-log.component';
...
describe('Component Tests', () => {
  describe('OrderLog Management Component', () => {
    let comp: OrderLogComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(OrderLogComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.orderLogs[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
