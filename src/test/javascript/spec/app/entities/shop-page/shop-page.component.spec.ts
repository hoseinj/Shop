...
describe('Component Tests', () => {
  describe('ShopPage Management Component', () => {
    let comp: ShopPageComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ShopPageComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.shopPages[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
