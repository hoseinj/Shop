...
import { BannerGroupComponent } from 'app/entities/banner-group/banner-group.component';
...
describe('Component Tests', () => {
  describe('BannerGroup Management Component', () => {
    let comp: BannerGroupComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(BannerGroupComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.bannerGroups[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
