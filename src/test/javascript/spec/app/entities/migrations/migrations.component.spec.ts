...
import { MigrationsComponent } from 'app/entities/migrations/migrations.component';
...
describe('Component Tests', () => {
  describe('Migrations Management Component', () => {
    let comp: MigrationsComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(MigrationsComponent, '')
        .compileComponents();
