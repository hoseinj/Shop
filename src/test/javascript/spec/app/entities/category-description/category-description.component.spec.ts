...
import { CategoryDescriptionComponent } from 'app/entities/category-description/category-description.component';
...
describe('Component Tests', () => {
  describe('CategoryDescription Management Component', () => {
    let comp: CategoryDescriptionComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CategoryDescriptionComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      spyOn(service, 'query').and.returnValue(
        of(
          new HttpResponse({
            body: [new CategoryDescription(123)],
            headers
          })
        )
      );
      ...
      expect(comp.categoryDescriptions[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
