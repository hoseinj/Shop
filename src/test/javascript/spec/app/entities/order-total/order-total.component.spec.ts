...
import { OrderTotalComponent } from 'app/entities/order-total/order-total.component';
...
describe('Component Tests', () => {
  describe('OrderTotal Management Component', () => {
    let comp: OrderTotalComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(OrderTotalComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.orderTotals[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
