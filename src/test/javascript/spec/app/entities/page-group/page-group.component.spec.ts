...
import { PageGroupComponent } from 'app/entities/page-group/page-group.component';
...
describe('Component Tests', () => {
  describe('PageGroup Management Component', () => {
    let comp: PageGroupComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(PageGroupComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.pageGroups[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
