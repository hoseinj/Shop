...
public class Zone implements Serializable {
    ...
    public Zone isActive(Integer isActive) {
    ...
    public Zone modifiedBy(Long modifiedBy) {
    ...
    public Zone createdDate(String createdDate) {
    ...
    public Zone modifiedDate(String modifiedDate) {
