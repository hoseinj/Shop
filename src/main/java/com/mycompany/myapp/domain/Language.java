...
public class Language implements Serializable {
    ...
    public Language image(String image) {
        this.image = image;
        return this;
    }
    ...
    public Language imagePath(String imagePath) {
    ...
    public Language sortOrder(String sortOrder) {
    ...
    public Language createdDate(String createdDate) {
    ...
    public Language modifiedDate(String modifiedDate) {
