...
public class AccessTokenResource {
    ...
    public ResponseEntity<AccessTokenDTO> createAccessToken(@RequestBody AccessTokenDTO accessTokenDTO) throws URISyntaxException {
        ...
        AccessTokenDTO result = accessTokenService.save(accessTokenDTO);
    ...
    public ResponseEntity<AccessTokenDTO> updateAccessToken(@RequestBody AccessTokenDTO accessTokenDTO) throws URISyntaxException {
    ...
    public ResponseEntity<List<AccessTokenDTO>> getAllAccessTokens(Pageable pageable) {
