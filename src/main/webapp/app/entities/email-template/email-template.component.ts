...
export class EmailTemplateComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    this.emailTemplateService
      ...
      .subscribe((res: HttpResponse<IEmailTemplate[]>) => this.paginateEmailTemplates(res.body, res.headers));
  }
  ...
  protected paginateEmailTemplates(data: IEmailTemplate[], headers: HttpHeaders) {
