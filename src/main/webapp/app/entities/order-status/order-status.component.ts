...
export class OrderStatusComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    this.orderStatusService
      ...
      .subscribe((res: HttpResponse<IOrderStatus[]>) => this.paginateOrderStatuses(res.body, res.headers));
  }
  ...
  protected paginateOrderStatuses(data: IOrderStatus[], headers: HttpHeaders) {
