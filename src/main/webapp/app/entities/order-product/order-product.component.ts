...
export class OrderProductComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    this.orderProductService
      ...
      .subscribe((res: HttpResponse<IOrderProduct[]>) => this.paginateOrderProducts(res.body, res.headers));
  }
  ...
  protected paginateOrderProducts(data: IOrderProduct[], headers: HttpHeaders) {
