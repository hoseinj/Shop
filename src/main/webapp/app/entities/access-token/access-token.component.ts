...
export class AccessTokenComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    this.accessTokenService
      ...
      .subscribe((res: HttpResponse<IAccessToken[]>) => this.paginateAccessTokens(res.body, res.headers));
  }
  ...
  protected paginateAccessTokens(data: IAccessToken[], headers: HttpHeaders) {
